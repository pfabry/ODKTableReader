...
The documentation for ODKTABLEREADER is managed in two places (relative to the repository root):
...
1. In your terminal, navigate to the edit directory of your ontology, e.g.:
   ```
   cd ODKTableReader/src/ontology
   ```
2. Now you are ready to build the docs as follows:
   ...
   ```
   INFO    -  Your documentation should shortly be available at: https://pfabry.github.io/ODKDocsTableReader/ 
   ```
3. Just to double check, you can now navigate to your documentation pages (usually https://pfabry.github.io/ODKDocsTableReader/). 
