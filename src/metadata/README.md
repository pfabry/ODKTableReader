 ...
 * [ODKTableReader.yml](ODKTableReader.yml)
     * Determines how your purl.obolibrary.org/obo/ODKTableReader/ redirects will be handled
     ...
     * Paste in the contents of [ODKTableReader.yml](ODKTableReader.yml)
 ...
 * [ODKTableReader.md](ODKTableReader.md)
     ...
     * Paste in the contents of [ODKTableReader.md](ODKTableReader.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
